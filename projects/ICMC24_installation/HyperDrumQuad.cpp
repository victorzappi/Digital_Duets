...
void HyperDrumQuad::init(int stateNum, int attrNum, int texW, int texH, float deltaTx, float deltaTy) {
...
void HyperDrumQuad::setQuad(int topleftX, int topleftY, int width, int height, int coordNShiftX) {
