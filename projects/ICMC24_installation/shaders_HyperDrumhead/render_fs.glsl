...
uniform int areaMicCanDrag[maxNumOfAreas];
...
void main() {
	...
	for(int i=0; i<numOfAreas; i++) {
		...
		//if(areaMicCanDrag[area]==1)
		listColor = color_lightRed*areaMicCanDrag[area] + (1-areaMicCanDrag[area])*color_purple2; // this was color_orange instead of color_purple2 originally
