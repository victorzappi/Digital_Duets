...
class HyperDrumhead: public DemoFDTD {
public:
...
private:
	...
	// make them private
	using DemoFDTD::setCell;
	using DemoFDTD::resetCell;
...
// simply to attain to super class standard way of retrieving type [in this case is much simpler than DemoFDTD class]
