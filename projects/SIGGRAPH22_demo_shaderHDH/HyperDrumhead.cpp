...
/*float *HyperDrumhead::getBufferFloatAreas(int numSamples, double *inputBuffer, double **areaInputBuffer) {
	...
	computeSamples(numSamples, areaInputBuffer);
...
/*void HyperDrumhead::computeSamplesAreas(int numSamples, double *inputBuffer, double **inputAreaBuffer) {
