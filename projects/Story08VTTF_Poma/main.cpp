...
//VIC update this project [audio engine and synth container], follow fdtd_example
...
bool auto_spacing_correction = false; // when non symmetric, this sizes down the tube to account for the extra length due to asymmetries
float radii_factor = 1; // to arbitrarily shrink the length of the vocal tract tubes
bool auto_radii_correction = true;
...
int period_size = 2048;//1024/*2048*/;     	// period length in frames
int buffer_size = 4096;//2048/*4096*/;		    // ring buffer length in frames [contains period]
