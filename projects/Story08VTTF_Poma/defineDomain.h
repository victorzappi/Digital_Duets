...
void story96Vowel(char vowel, float ***&domainPixels, int asymmetric, bool nasal=false);
void story08Vowel(char vowel, float ***&domainPixels, int asymmetric, bool nasal=false);
