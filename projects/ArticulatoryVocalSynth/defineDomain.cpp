...
//	/monitorIndex = 1;
	...
	domainSize[0] = 120;//308;//320//148;//92; //400;
	domainSize[1] = 120;//228;//240//108;//92; //400;
...
void customTube(float ***&domainPixels) {
	...
	//listenerCoord[0] = createStraightTube(0.15468, 0.003, domainSize, domainPixels);
	bool piston = true;
	if(piston) {
		excitationDim[0] = 1;
		excitationDim[1] = widthPixels;

		excitationCoord[0] = 0;
		excitationCoord[1] -= (widthPixels+1)/2 - 1;
	}
	//-----------------------------------------------------
}
...
/*
	rate_mul = 4;
	domainSize[0] = 80;//200;//182;
	domainSize[1] = 40;//60;//60;
*/
